...
const CoursesSection = () => {
    ...
    return (
        <div className='py-16 md:px-40 px-8'>
            ...
            <div className='grid gridTempleteColumns  gap-4 md:px-0 px-4 md:my-16  my-10'>
                {allCourse.slice(0, 4).map((course, index) => <CourseCard key={index} course={course} />)}
            </div>


            <Link className='text-gray-500 border border-gray-500/30 px-10 py-3 rounded' to={'/course-list'} onClick={() => {
                scrollTo(0, 0)
